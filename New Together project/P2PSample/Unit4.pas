...
begin
  ...
  PortSIP_setAudioDeviceId(PortSIPHandle, comboBoxMicrophone.ItemIndex, comboBoxSpeaker.ItemIndex);   // SetAudioDevice
  HasSDP := false;
...
begin
  ...
  ComboBoxSpeaker.Clear;
  ComboBoxMicrophone.Clear;
end;
